...
- Rainbow Linux is an **independent** Linux distribution that uses [Miyav Package Manager](https://github.com/rainbow-linux/miyav-pm) which is developed by the Rainbow Linux team.
